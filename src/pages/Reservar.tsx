...
const reservationSchema = z.object({
  route: z.string({
    required_error: "Por favor selecciona una ruta",
  ...
  participants: z.string({
    required_error: "Indica el número de personas",
  }).refine((val) => {
    const num = parseInt(val);
    return !isNaN(num) && num >= 1 && num <= 20;
  }, {
    message: "Debe ser entre 1 y 20 personas",
  }),
        ...
        <div className="container px-4 sm:px-6 lg:px-8 max-w-4xl">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-muted-foreground">
              Completa el formulario y conecta con las comunidades locales
            </p>
          </div>
          ...
          <Card className="shadow-lg">
            <CardHeader>
              ...
              <CardDescription>
                Todos los campos marcados son obligatorios para confirmar tu reserva
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Form {...form}>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-col">
                          ...
                          <FormDescription>
                            Selecciona el día que deseas visitar
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Textarea
                                placeholder="¿Tienes alguna preferencia o necesidad especial? Déjanos saber..."
